        ...
        sites=(
            SiteConfig(
                ...
                settings={
                    ...
                    "username_selector": "input[name=\"txtID\"], input[placeholder*=\"ID\"], input[type=\"text\"]",
                    "password_selector": "input[name=\"txtPWD\"], input[placeholder*=\"PASSWORD\"], input[type=\"password\"]",
                    "submit_selector": "button:has-text(\"로그인\"), input[type=\"submit\"], input[type=\"button\"], a:has-text(\"로그인\")",
                    "headless": True,
